    ...
    <div className="w-full">
      ...
      <section className="bg-gradient-to-br from-primary to-primary/80 text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white/90">
            Kami siap membantu menjawab pertanyaan Anda tentang program dan layanan kami
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow text-center">
            ...
            <p className="text-gray-600 mb-4">Hubungi kami melalui email untuk pertanyaan umum</p>
            <a
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Hubungi Kami Melalui</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="font-semibold text-gray-900 text-sm text-center">Email</span>
            </a>
            ...
            >
              ...
              <span className="font-semibold text-gray-900 text-sm text-center">Telepon</span>
            </a>
            ...
            >
              ...
              <span className="font-semibold text-gray-900 text-sm text-center">Lokasi</span>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Jam Operasional</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Hari Kerja</h3>
              <div className="space-y-3 text-gray-700">
                <div className="flex justify-between">
                  <span>Senin - Jumat</span>
                  <span className="font-semibold">08:00 - 18:00</span>
                </div>
                <p className="text-sm text-gray-600">Istirahat: 12:00 - 13:00</p>
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Akhir Pekan</h3>
              <div className="space-y-3 text-gray-700">
                <div className="flex justify-between">
                  <span>Sabtu</span>
