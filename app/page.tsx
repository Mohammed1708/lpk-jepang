  ...
  return (
    <main className="w-full min-h-screen flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat relative">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 md:px-6">
        {/* Headline */}
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-10 text-balance">
          ビナワン・トレーニングセンターへようこそ
        </h1>
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-12 md:mb-16 text-balance">
          SELAMAT DATANG DI 
